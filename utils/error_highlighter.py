"""
Error Highlighter Utility

This module contains functions for highlighting errors in XML content
by adding [ERROR_START] and [ERROR_END] markers around problematic elements.
"""
...
def highlight_error_in_xml(xml_content: str, error_id: str, error_message: str, 
                          element_id: str, main_xml_content: str) -> str:
    """
    ...
    try:
        ...
        container_element = get_container_element_for_input(target_element, tree)
        
        # Get the parent element for highlighting (immediate parent)
        parent_element = get_parent_element_for_highlighting(target_element, tree)
        ...
        highlighted_xml = highlight_element_within_container(container_xml, target_element, error_id)
...
def get_parent_element_for_highlighting(target_element: etree._Element, tree: etree._Element) -> Optional[etree._Element]:
    """
...
def get_container_element_for_input(target_element: etree._Element, tree: etree._Element) -> Optional[etree._Element]:
    """
...
def highlight_element_within_container(container_xml: str, target_element: etree._Element, error_id: str) -> str:
    """
...
def get_clean_output_xml(element_id: str, completed_xml_content: str) -> str:
    """
